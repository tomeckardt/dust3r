...
from dust3r.model import load_model, inf  # noqa: F401, needed when loading the model
...
def get_args_parser():
    ...
    parser.add_argument('--freeze', default=None, type=str, help="which weights to freeze")
...
def loss_of_one_batch(batch, model, criterion, device, symmetrize_batch=False, use_amp=False, ret=None):
    view1, view2, view3 = batch
    ignore_keys = set(['depthmap', 'dataset', 'label', 'instance', 'idx', 'true_shape', 'rng', 'view_label'])
    for view in batch:
    ...
    if symmetrize_batch:
        view1, view2 = make_batch_symmetric(batch[:2])

    with torch.amp.autocast("cuda", enabled=bool(use_amp)):
        pred1, pred2 = model(view1, view2, view3)
